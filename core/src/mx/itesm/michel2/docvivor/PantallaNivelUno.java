...
public class PantallaNivelUno extends Pantalla {
    ...
    private void crearPersonaje() {
        ...
        jugador = new Jugador(texturaPersonaje,texturaFondoNivelUno.getWidth()/2,129);
        rectanglePersonaje = jugador.sprite.getBoundingRectangle().setSize(texturaPersonaje.getWidth()*.33f,texturaPersonaje.getHeight());
